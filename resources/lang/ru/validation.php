...
return [
    ...
    */
    ...
    'custom' => [
        'REG.LOGIN' => [
            'required' => 'Поле Логин обязаетльно для заполнения',
            'alpha_latin_num' => 'Поле Логин может содержать только буквы латинского алфавита и цифры от 0 до 9',
            'unique' => 'Пользователь с данным Логином уже существует',
        ],
        'REG.PASSWORD' => [
            'required' => 'Поле c паролем не может быть пустым',
            'confirmed' => 'Пароли не совпадают',
            'unique' => 'Пароль должен содержать не менее 6 символов'
        ],
        'REG.EMAIL' => [
            'email' => 'Поле e-mail должно быть действительным электронным адресом.',
            'confirmed' => 'Пароли не совпадают',
            'unique' => 'Пользователь с данной почтой уже существует'
        ],
        'REG.NAME' => [
        ...
        'name' => [
            'required' => 'Название цели должно быть заполнено',
            'alpha' => 'Название цели должно содержать только буквы  и цифры',
            'unique' => 'Цель с такми названием уже существует Название цели быть уникальным',
        ],
        'start' => [
            'required' => 'Дата начала должна быть указана',
        ],
        'text' => [
            'required' => 'Описание цели - обязательное поле',
        ],
